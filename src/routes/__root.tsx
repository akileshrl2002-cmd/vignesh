...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vignesh A — AWS Cloud Engineer Portfolio" },
      { name: "description", content: "Portfolio of Vignesh A — AWS Cloud Engineer designing scalable, secure, and highly available cloud infrastructure." },
      { name: "author", content: "Vignesh A" },
